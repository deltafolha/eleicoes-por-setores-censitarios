...
* [Resultado agregado por setores censitários](https://drive.google.com/file/d/19U7m-P-yT_zmqt88-c1GZahEpSrwxAJu/view?usp=sharing) (criados pelo código `04_resultados_por_setor`): Os arquivos estão nomedos como `<ano_malha>_<id_ibge_cidade>_<ano_eleicao>_<cargo>_<turno>_<classe_de_agregacao>.csv` (São 715 mil arquivos que descopatados totalizam 189 gb).
